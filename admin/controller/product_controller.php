...
if (isset($_POST["update-product-submit"])) {
    ...
    if (isset($image_file_name)) {
        $update_product_sql = "UPDATE product SET name = '$name', image ='$image_file_name', price ='$price', category = '$category', quantity = '$quantity', description = '$description' WHERE id = '$id'";
    } else {
