...
">
        ...
        <a id="customer-delete-btn" href="./controller/customer_controller.php?remove_customer_id=<?php echo $row['id']; ?>" onclick="return confirmDelete();">Delete account</a>
        <a id="customer-back-btn" href="./customer_manager.php">Back</a>
